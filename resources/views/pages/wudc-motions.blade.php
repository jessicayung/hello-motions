...
@section('content')  
  ...
  <h3>2021 Korea WUDC</h3>
  <p><b>CA Team</b>: Dan Lahav, Mubarrat Wassey, Bobbi Leet, Boemo Delano Phirinyane, Connor O'Brien, Milos Marjanovic, Sebastian Dasso, Sooyoung Park, Teck Wei Tan, Tejal Patwardhan</p>

  <p><b>Motions</b>: We'll find out soon! :) For more info visit <a href="https://www.facebook.com/koreawudc2021/">the Korea WUDC facebook page</a>.</p>
  <p>
  <ul>
    <li><a href="http://hellomotions.com/search?q=Dan+Lahav%2C+Mubarrat+Wassey%2C+Bobbi+Leet%2C+Boemo+Delano+Phirinyane%2C+Connor+O%27Brien%2C+Milos+Marjanovic%2C+Sebastian+Dasso%2C+Sooyoung+Park%2C+Teck+Wei+Tan%2C+Tejal+Patwardhan&intl=0">Motions set by members of the Korea WUDC CA Team</a></li>
  </ul>  
  </p>

  <h3>Shortcuts to 2007-2020 WUDC motions</h3>
  <p>
  <ul>
    <li><a href="#wudc2019">2020</a> <a href="#wudc2019">2019</a> <a href="#wudc2018">2018</a> <a href="#wudc2017">2017</a> <a href="#wudc2016">2016</a> <a href="#wudc2015">2015</a> <a href="#wudc2014">2014</a> <a href="#wudc2013">2013</a> <a href="#wudc2012">2012</a> <a href="#wudc2011">2011</a></li>
    <li><a href="#wudc2010">2010</a> <a href="#wudc2009">2009</a> <a href="#wudc2008">2008</a> <a href="#wudc2007">2007</a></li>
  </ul>
  </p>

  <h3>2020 Thailand WUDC</h3>
  <p><b>CA Team</b>: Ashish Kumar, Jasmine Ho, Michael Dunn-Goekjian, Ayal Hayut-Man, Archie Hall, Mayu Arimoto, Lucia Arce, Julio Meyer, Evan Lynyak, Cliff Simataa, Jessica Musulin</p>
  ...
  <table class="table table-striped">
    ...
    @foreach ($wudc2020motions as $motion)
      <tr>
        <td> {{ $motion ->Round }} </td>
        <td> {{ $motion ->Motion }} </td>
  ...
  <h3 id="wudc2019">2019 Cape Town WUDC</h3>
  ...
  <table class="table table-striped">
    ...
    @foreach ($wudc2019motions as $motion)
      <tr>
        <td> {{ $motion ->Round }} </td>
        <td> {{ $motion ->Motion }} </td>
        <td> {{ $motion ->Infoslide }} </td>
