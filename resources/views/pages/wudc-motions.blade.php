...
@section('content')  
  ...
  <p><b>Motions</b>: We'll find out soon! :) For more info visit <a href="https://www.facebook.com/THAILANDWORLDS/">the Thailand WUDC facebook page</a>.</p>
  <p>
  <ul>
    <li><a href="http://hellomotions.com/search?q=Ashish+Kumar%2C+Jasmine+Ho%2C+Michael+Dunn-Goekjian%2C+Ayal+Hayut-Man%2C+Archie+Hall%2C+Mayu+Arimoto%2C+Lucia+Arce%2C+Julio+Meyer%2C+Evan+Lynyak%2C+Cliff+Simataa%2C+Jessica+Musulin&search-motions=">Motions set by members of the Thailand WUDC CA Team</a></li>
  </ul>  
  </p>
